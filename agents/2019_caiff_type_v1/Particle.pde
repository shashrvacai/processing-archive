...
class Particle {
  ...
  void display() {
    fill(255); // white fill
    stroke(255, 125); // transparant black stroke
    float r = 4 * life/maxLife; // radius of the ellipse
