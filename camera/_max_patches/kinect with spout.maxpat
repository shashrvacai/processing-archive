...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 721.0, 719.0, 50.0, 174.0 ],
					"style" : "",
					"text" : "0.159192 -0.741373 -0.467033 0.020724 -0.452373 -0.238335"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 2494.25, 321.0, 32.5, 22.0 ],
					"style" : "",
					"text" : "360"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 2444.25, 321.0, 32.5, 22.0 ],
					"style" : "",
					"text" : "640"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 2494.25, 348.0, 50.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 2444.25, 348.0, 50.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 2444.25, 381.0, 99.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 2404.25, 268.0, 60.0, 22.0 ],
					"style" : "",
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 2713.25, 435.0, 37.0, 22.0 ],
					"style" : "",
					"text" : "clear"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 2773.25, 499.0, 73.0, 42.0 ],
					"style" : "",
					"text" : "select sender"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 2609.25, 552.0, 125.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 2609.25, 435.0, 98.0, 22.0 ],
					"style" : "",
					"text" : "prepend append"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 2609.25, 398.0, 157.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					"allowdrag" : 0,
					"id" : "obj-124",
					"items" : [ "Spout Processing", ",", "Spout Processing_1", ",", "Spout Processing_10", ",", "Spout Processing_2", ",", "Spout Processing_3", ",", "Spout Processing_4", ",", "Spout Processing_5", ",", "Spout Processing_6", ",", "Spout Processing_7", ",", "Spout Processing_8" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 2609.25, 510.0, 158.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 2562.25, 510.0, 34.0, 22.0 ],
					"style" : "",
					"text" : "print"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 2334.25, 403.0, 70.0, 22.0 ],
					"style" : "",
					"text" : "r prerender"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 2435.25, 419.0, 117.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 2168.0, 250.0, 72.0, 22.0 ],
					"style" : "",
					"text" : "loadmess 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 2192.0, 277.0, 25.0, 20.0 ],
					"style" : "",
					"text" : "go"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 2406.25, 474.0, 175.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 2168.0, 277.0, 20.0, 20.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 2406.25, 510.0, 139.0, 50.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 2192.0, 367.0, 72.0, 22.0 ],
					"style" : "",
					"text" : "s prerender"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 2168.0, 337.0, 67.0, 22.0 ],
					"style" : "",
					"text" : "t b b erase"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 2168.0, 304.0, 58.0, 22.0 ],
					"style" : "",
					"text" : "qmetro 5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 2168.0, 446.0, 117.5, 50.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 2168.0, 404.0, 138.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 319.0, 728.0, 173.0, 22.0 ],
					"presentation" : 1,
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 2618.75, 590.0, 2381.25, 590.0, 2381.25, 451.0, 2415.75, 451.0 ],
					"source" : [ "obj-120", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 2343.75, 451.0, 2415.75, 451.0 ],
					"source" : [ "obj-126", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 2571.75, 503.0, 2593.25, 503.0, 2593.25, 371.0, 2618.75, 371.0 ],
					"source" : [ "obj-132", 1 ]
				}
