...
import processing.opengl.PGraphics2D;
  ...
  public void setup(){
    ...
    particles.param.col_A = new float[]{0.30f, 0.10f, 0.15f, 5};
    particles.param.col_B = new float[]{0.10f, 0.20f, 1f, 0};
  ...
  void updateScene(){
    ...
    {
      float px = sin(frameCount/100f) * 0.8f * w/2;
      pg_obstacles.translate(w/2 + px, h/4);
      pg_obstacles.rotate(frameCount/12f);
      pg_obstacles.fill(0, 255);
      //pg_obstacles.rect(0, 0,  10, dim/4);
