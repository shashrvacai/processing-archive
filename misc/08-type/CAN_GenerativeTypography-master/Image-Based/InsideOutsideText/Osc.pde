void oscEvent(OscMessage theOscMessage) {       /// osc message to MAX
  ...
  if (theOscMessage.checkAddrPattern("/pT1")) {   //  message reciever      
    pT1 = v1;
  } else if (theOscMessage.checkAddrPattern("/pT2")) {   //  message reciever      
    pT2 = v2;
  } else if (theOscMessage.checkAddrPattern("/pT3")) {   //  message reciever      
    pT3 = v3;
  } 
