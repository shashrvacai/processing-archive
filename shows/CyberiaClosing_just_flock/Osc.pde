void oscEvent(OscMessage theOscMessage) {       /// osc message to MAX
  ...
  float v17 = theOscMessage.get(0).floatValue();
    float v18 = theOscMessage.get(0).floatValue(); 
  float v19 = theOscMessage.get(0).floatValue();
  ...
  if (theOscMessage.checkAddrPattern("/cc1")) {   //  message reciever      
   ...
   cc3 = v3;
    ...
    cc17 = v17;
  }  else if (theOscMessage.checkAddrPattern("/cc18")) {   //  message reciever      
    cc18 = v18;
  } else if (theOscMessage.checkAddrPattern("/cc19")) {   //  message reciever      
    cc19= v19;
  }
} 
