...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "float" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 2115.0, 405.330017, 40.0, 40.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 1267.0, 401.330017, 40.0, 40.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 730.0, 722.0, 74.0, 22.0 ],
					"style" : "",
					"text" : "180. 0. 1. 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 705.0, 652.0, 58.0, 22.0 ],
					"style" : "",
					"text" : "0. 0. -1.6"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 708.0, 572.0, 34.0, 22.0 ],
					"style" : "",
					"text" : "546."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 439.75, 229.0, 51.0, 22.0 ],
					"style" : "",
					"text" : "0. -5. 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 423.0, 179.0, 54.0, 22.0 ],
					"style" : "",
					"text" : "0. 0.5 0."
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 1946.0, 945.0, 139.0, 22.0 ],
					"style" : "",
					"text" : "jit.matrix 4 char 720 900"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 1304.0, 681.330017, 40.0, 40.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 903.0, 343.883484, 87.0, 23.0 ],
					"style" : "",
					"text" : "fullscreen $1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 903.0, 316.883484, 20.0, 20.0 ],
					"style" : ""
				}
...
,
					"patching_rect" : [ 927.5, 316.883484, 42.0, 23.0 ],
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 523.0, 18.0, 30.0, 30.0 ],
									"style" : ""
								}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 1280.0, 712.0, 282.0, 22.0 ],
					"style" : "",
					"text" : "jit.gl.mesh @draw_mode points @axes 0 1024 760"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 37.000004, -0.5, 104.0, 104.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 315.0, 70.0, 156.0, 38.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 92.0, 210.0, 321.0, 22.0 ],
					"presentation" : 1,
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 912.5, 337.666679, 912.5, 337.666679 ],
					"source" : [ "obj-66", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 937.0, 340.666679, 924.0, 340.666679, 924.0, 313.666679, 912.5, 313.666679 ],
					"source" : [ "obj-67", 0 ]
				}
