...
int numPoints = 550;                  // the number of points generated
...
void draw() {
  ...
  maxDistance = map(mouseX, 0,width,25,100);
  numPoints = (int)map(mouseY,0,height,450,40);
